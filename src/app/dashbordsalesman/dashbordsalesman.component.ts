...
@Component({
  selector: 'app-dashbordsalesman',
  templateUrl: './dashbordsalesman.component.html',
  styleUrls: ['./dashbordsalesman.component.css']
})
export class DashbordsalesmanComponent  {
